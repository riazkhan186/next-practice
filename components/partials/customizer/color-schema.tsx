                ...
                {allThemes?.map((themeOption) => (
                    <div key={themeOption.key} className="flex-1 w-full">
                        <button
                            ...
                            className={cn(
                                "border border-solid flex border-default-300 w-full text-center items-center justify-center py-[14px]  px-10 rounded relative cursor-pointer",
                                {
                                    "text-default border-default-700! dark:border-default-600!": theme === themeOption.key,
