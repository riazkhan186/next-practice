          ...
          <div className="text-center mx-auto py-1">
            {row.getValue("status") === "progress" && (
              <span className="flex items-center gap-3">
                <span className="h-1.5 w-1.5 bg-destructive rounded-full inline-block ring-4 ring-destructive/50"></span>
                <span>In progress</span>
              </span>
            )}
            {row.getValue("status") === "complete" && (
              <span className="flex items-center gap-3">
                <span className="h-1.5 w-1.5 bg-success rounded-full inline-block ring-4 ring-success/50"></span>
                <span>Complete</span>
              </span>
            )}
          </div>
