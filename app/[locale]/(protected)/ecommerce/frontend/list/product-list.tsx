  ...
  return (
    <Card className="p-3 rounded-md 2xl:flex lg:flex md:flex-none sm:flex-none group">
      <Link href={`/ecommerce/frontend/${product.id}`}>
        <div className=" bg-default-200 dark:bg-default-900  relative h-[259px] flex flex-col justify-center items-center rounded-md  mb-3 lg:mb-0   md:ltr:mr-0 sm:ltr:mr-0 md:rtl:ml-0 sm:rtl:ml-0 lg:ltr:mr-3 lg:rtl:ml-3">
