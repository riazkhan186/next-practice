            ...
            <div className="flex-1 flex  items-center gap-3">
              {menus?.map(({ href, active, icon }, index) => (
                <Button
                  ...
                  size="icon"
                  variant="outline"
                  className={cn("border border-default-400 text-default-400 hover:bg-transparent hover:text-default! h-11 w-11 hover:border-default!",
                    { "text-default border-default! hover:text-default ": active }
                  )}
                >
                  <Link href={href}>
            ...
            <div className="flex-none sm:flex items-center gap-4 sm:space-y-0 space-y-2">
              <div className=" flex gap-2  items-center">
                ...
                <Select defaultValue={selectOptions[0].value}>
                  <SelectTrigger className="bg-transparent w-[110px] border-default-200 h-10 cursor-pointer">
