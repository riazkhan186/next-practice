    ...
    <div>
      ...
      <div className="space-y-5">
        <div className="grid lg:grid-cols-3 md:grid-cols-2 grid-cols-1 gap-5">
          ...
          <WelcomeBlock>
            <div className="max-w-[180px] relative z-10">
              ...
              <p className="text-sm text-primary-foreground dark:text-default-800/80">
          ...
          <WelcomeBlock className="bg-default">
            ...
            <BlockBadge className="bg-destructive text-destructive-foreground dark:bg-default-100 dark:text-default-900">
              Now
            </BlockBadge>
          </WelcomeBlock>
          {/* Block 8 */}
          <WelcomeBlock className="bg-primary">
            <div className="max-w-[180px] relative z-10">
              ...
              <p className="text-sm text-primary-foreground dark:text-default-900/80">
                Pro plan for better results
              </p>
            </div>
            <BlockBadge className="bg-success text-success-foreground">
              Now
            </BlockBadge>
          </WelcomeBlock>
          {/* Block 9 */}
          <WelcomeBlock className="bg-linear-to-r from-primary to-success">
            ...
            <BlockBadge className="bg-warning text-warning-foreground">
              Now
            </BlockBadge>
          </WelcomeBlock>
          {/* Block 10 */}
            ...
            <div className="flex-1 relative z-10">
              <div className="max-w-[180px]">
                <h4 className="text-2xl font-medium mb-2">
                  <span className="block text-sm text-default-800 dark:text-default-100">
                    Current balance,
                  </span>
                  <span className="block text-default-900 dark:text-default-100">
                    $34,564
                  </span>
                </h4>
              </div>
        ...
        <div className="grid xl:grid-cols-6 lg:grid-cols-4 md:grid-cols-2 grid-cols-1 gap-5">
          <UpgradeBlock className="bg-default dark:bg-default-200 mt-14">
          ...
          {["primary", "success", "info", "destructive", "warning"].map(
            (item, index) => (
              <UpgradeBlock key={index} className={`bg-${item} mt-14`}>
                ...
                <div className="mt-6">
                  <Button
                    fullWidth
                    size="md"
                    className="bg-primary-foreground hover:ring-0  hover:ring-offset-0 ring-offset-transparent dark:bg-white dark:text-default-100 hover:bg-primary-foreground hover:text-default hover:opacity-90 text-default"
                  >
                    Upgrade
                  </Button>
                </div>
