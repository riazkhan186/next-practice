  ...
  return (
    <div className="w-full bg-default-50  p-6 rounded-lg">
      <div className="pb-5">
        <div className="grid grid-cols-12  md:gap-4 md:space-y-0 space-y-4 sm:space-y-4 ">
          ...
          <div className="col-span-12 md:col-span-7 lg:col-span-8 space-y-2 ">
            ...
            <div className="flex flex-wrap gap-2 sm:gap-4 pb-5 justify-center sm:justify-start">
              <Button
                size="md"
                variant="outline"
              ...
              <Button size="md" className="cursor-pointer w-full sm:w-auto">
                <Icon
            ...
            <div className="flex gap-3 ">
              ...
              <div className="flex flex-wrap items-center gap-3 ">
                <button
                  type="button"
                  className="border border-solid p-2 rounded h-8 w-8 flex justify-center items-center cursor-pointer"
                >
                  <Image
                    height={500}
                    width={500}
      ...
      <div className="space-y-5">
              ...
              <Tabs defaultValue="description">
                ...
                <TabsContent value="description">
                  <div className="text-default-600  text-sm lg:text-base font-normal">
                    ...
                    <ul className="space-y-3 p-4 sm:p-6 lg:ml-20 sm:ml-10 ml-6 rounded-md bg-default-white">
                      {lists.map((item, i) => (
                        <li
                          key={i}
                          className="text-sm sm:text-base text-default-600 flex gap-2 items-center"
                        >
                          <span className="min-w-[10px] min-h-[10px] bg-default-900 rounded-full inline-block"></span>
                          <span>Lorem ipsum dolor sit amet.</span>
                        </li>
                      ))}
                    </ul>

                    <p className="text-default-600 text-sm sm:text-base font-normal">
                      Lorem ipsum dolor sit amet, consetetur sadipscing elitr,
                      sed diam nonumy eirmod tempor invidunt ut labore et dolore
                      magna. Lorem ipsum dolor sit amet, consetetur sadipscing
                      elitr, sed diam nonumy eirmod tempor invidunt ut labore et
        ...
        <div className="border border-solid rounded p-6">
